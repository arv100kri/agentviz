...
class RootErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) {
    console.error("[FAX-VIZ crash]", error, info && info.componentStack);
  }
  ...
  render() {
    if (this.state.hasError) {
      var msg = this.state.error && this.state.error.message
      ...
      return React.createElement("div", {
        ...
        React.createElement("div", { style: { fontSize: 18, color: "#ff6b6b" } }, "FAX-VIZ crashed"),
        ...
        React.createElement("button", {
          ...
          style: {
            ...
            borderRadius: 6, color: "#c9d1d9", cursor: "pointer",
